...
def dose_amount():
    diagnosis = diagnosis_selection()
    weight_input = weight_selection()
    (weight, dosage_mg_first_day) = weight_conversion(weight_input, diagnosis)
...
def weight_conversion(weight_input, diagnosis):
